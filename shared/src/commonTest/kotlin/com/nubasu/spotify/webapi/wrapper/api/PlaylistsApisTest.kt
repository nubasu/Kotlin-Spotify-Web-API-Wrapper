...
class PlaylistsApisTest {
    ...
    @Test
    fun getPlaylist_nonSuccess_throws_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created { client -> PlaylistsApis(client).getPlaylist("playlist-id") }
        }

    @Test
    fun getPlaylist_nonSuccess_throws_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client -> PlaylistsApis(client).getPlaylist("playlist-id") }
        }

    @Test
    fun getPlaylist_nonSuccess_throws_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client -> PlaylistsApis(client).getPlaylist("playlist-id") }
        }

    @Test
    fun getPlaylist_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client -> PlaylistsApis(client).getPlaylist("playlist-id") }
        }

    @Test
    fun changePlaylistDetails_nonSuccess_throws_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created { client ->
                PlaylistsApis(client).changePlaylistDetails("playlist-id", ChangePlaylistDetailsRequest(name = "n"))
            }
        }

    @Test
    fun changePlaylistDetails_nonSuccess_throws_status401_unauthorized() =
        runTest {
    ...
    @Test
    fun changePlaylistDetails_nonSuccess_throws_status403_forbidden() =
        runTest {
    ...
    @Test
    fun changePlaylistDetails_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
    ...
    @Test
    fun getPlaylistItems_nonSuccess_throws_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created { client -> PlaylistsApis(client).getPlaylistItems("playlist-id") }
        }

    @Test
    fun getPlaylistItems_nonSuccess_throws_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client -> PlaylistsApis(client).getPlaylistItems("playlist-id") }
        }

    @Test
    fun getPlaylistItems_nonSuccess_throws_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client -> PlaylistsApis(client).getPlaylistItems("playlist-id") }
        }

    @Test
    fun getPlaylistItems_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client -> PlaylistsApis(client).getPlaylistItems("playlist-id") }
        }

    @Test
    fun updatePlaylistItems_nonSuccess_throws_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created { client ->
                PlaylistsApis(client).updatePlaylistItems("playlist-id", UpdatePlaylistItemsRequest(uris = listOf("spotify:track:1")))
            }
        }

    @Test
    fun updatePlaylistItems_nonSuccess_throws_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client ->
                PlaylistsApis(client).updatePlaylistItems("playlist-id", UpdatePlaylistItemsRequest(uris = listOf("spotify:track:1")))
            }
    ...
    @Test
    fun updatePlaylistItems_nonSuccess_throws_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client ->
                PlaylistsApis(client).updatePlaylistItems("playlist-id", UpdatePlaylistItemsRequest(uris = listOf("spotify:track:1")))
            }
    ...
    @Test
    fun updatePlaylistItems_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client ->
                PlaylistsApis(client).updatePlaylistItems("playlist-id", UpdatePlaylistItemsRequest(uris = listOf("spotify:track:1")))
            }
    ...
    @Test
    fun addItemsToPlaylist_nonSuccess_throws_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created { client ->
                PlaylistsApis(client).addItemsToPlaylist("playlist-id", AddItemsToPlaylistRequest(uris = listOf("spotify:track:1")))
            }
        }

    @Test
    fun addItemsToPlaylist_nonSuccess_throws_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client ->
                PlaylistsApis(client).addItemsToPlaylist("playlist-id", AddItemsToPlaylistRequest(uris = listOf("spotify:track:1")))
            }
    ...
    @Test
    fun addItemsToPlaylist_nonSuccess_throws_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client ->
                PlaylistsApis(client).addItemsToPlaylist("playlist-id", AddItemsToPlaylistRequest(uris = listOf("spotify:track:1")))
            }
    ...
    @Test
    fun addItemsToPlaylist_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client ->
                PlaylistsApis(client).addItemsToPlaylist("playlist-id", AddItemsToPlaylistRequest(uris = listOf("spotify:track:1")))
            }
    ...
    @Test
    fun removePlaylistItems_nonSuccess_throws_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created { client ->
                PlaylistsApis(
                    client,
                ).removePlaylistItems("playlist-id", RemovePlaylistItemsRequest(items = listOf(TrackUri("spotify:track:1"))))
            }
        }

    @Test
    fun removePlaylistItems_nonSuccess_throws_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client ->
                PlaylistsApis(
                    client,
    ...
    @Test
    fun removePlaylistItems_nonSuccess_throws_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client ->
                PlaylistsApis(
                    client,
    ...
    @Test
    fun removePlaylistItems_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client ->
                PlaylistsApis(
                    client,
    ...
    @Test
    fun createPlaylist_nonSuccess_throws_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client ->
                PlaylistsApis(client).createPlaylist(CreatePlaylistRequest(name = "test"))
            }
    ...
    @Test
    fun createPlaylist_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client ->
                PlaylistsApis(client).createPlaylist(CreatePlaylistRequest(name = "test"))
            }
    ...
    @Suppress("DEPRECATION")
    @Test
    fun createPlaylistDeprecated_nonSuccess_throws_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created { client ->
                PlaylistsApis(client).createPlaylist("user-id", CreatePlaylistRequest(name = "test"))
            }
        }

    @Test
    fun createPlaylistDeprecated_nonSuccess_throws_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client ->
                PlaylistsApis(client).createPlaylist("user-id", CreatePlaylistRequest(name = "test"))
            }
    ...
    @Test
    fun createPlaylistDeprecated_nonSuccess_throws_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client ->
                PlaylistsApis(client).createPlaylist("user-id", CreatePlaylistRequest(name = "test"))
            }
    ...
    @Test
    fun createPlaylistDeprecated_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client ->
                PlaylistsApis(client).createPlaylist("user-id", CreatePlaylistRequest(name = "test"))
            }
    ...
    @Test
    fun getPlaylistCoverImage_nonSuccess_throws_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created { client -> PlaylistsApis(client).getPlaylistCoverImage("playlist-id") }
        }

    @Test
    fun getPlaylistCoverImage_nonSuccess_throws_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client -> PlaylistsApis(client).getPlaylistCoverImage("playlist-id") }
        }

    @Test
    fun getPlaylistCoverImage_nonSuccess_throws_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client -> PlaylistsApis(client).getPlaylistCoverImage("playlist-id") }
        }

    @Test
    fun getPlaylistCoverImage_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client -> PlaylistsApis(client).getPlaylistCoverImage("playlist-id") }
        }

    @Test
    fun addCustomPlaylistCoverImage_nonSuccess_throws_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created { client ->
                PlaylistsApis(client).addCustomPlaylistCoverImage("playlist-id", "base64jpeg")
            }
        }

    @Test
    fun addCustomPlaylistCoverImage_nonSuccess_throws_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client ->
                PlaylistsApis(client).addCustomPlaylistCoverImage("playlist-id", "base64jpeg")
            }
    ...
    @Test
    fun addCustomPlaylistCoverImage_nonSuccess_throws_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client ->
                PlaylistsApis(client).addCustomPlaylistCoverImage("playlist-id", "base64jpeg")
            }
    ...
    @Test
    fun addCustomPlaylistCoverImage_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client ->
                PlaylistsApis(client).addCustomPlaylistCoverImage("playlist-id", "base64jpeg")
            }
    ...
    @Test
    fun getPlaylist_success_allowsFollowersAndItemsPayload() =
        runTest {
            val body =
                """
                {
            ...
            assertEquals(
                "track",
                data.value.items?.items?.first()?.item?.let {
                    (it as? com.nubasu.spotify.webapi.wrapper.response.tracks.TrackObject)?.type
                },
            )
        }

    @Test
    fun getCurrentUsersPlaylists_success_allowsNullImages() =
        runTest {
            val body =
                """
                {
    ...
    @Test
    fun getCurrentUsersPlaylists_success_allowsItemsWithoutTracks() =
        runTest {
            val body =
                """
                {
    ...
    @Test
    fun removePlaylistItems_requestSerializesAsItems() =
        runTest {
            val body =
                """
                {"snapshot_id":"next"}
