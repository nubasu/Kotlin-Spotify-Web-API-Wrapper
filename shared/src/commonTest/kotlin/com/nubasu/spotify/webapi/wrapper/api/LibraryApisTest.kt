...
class LibraryApisTest {
    @Test
    fun getUsersSavedLibrary_status201_created() =
        runTest {
    ...
    @Test
    fun getUsersSavedLibrary_status401_unauthorized() =
        runTest {
    ...
    @Test
    fun getUsersSavedLibrary_status403_forbidden() =
        runTest {
    ...
    @Test
    fun getUsersSavedLibrary_status429_tooManyRequests() =
        runTest {
    ...
    @Test
    fun saveItemsForCurrentUser_status201_created() =
        runTest {
    ...
    @Test
    fun saveItemsForCurrentUser_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client ->
                LibraryApis(client).saveItemsForCurrentUser(listOf("spotify:track:t1"))
            }
    ...
    @Test
    fun saveItemsForCurrentUser_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client ->
                LibraryApis(client).saveItemsForCurrentUser(listOf("spotify:track:t1"))
            }
    ...
    @Test
    fun saveItemsForCurrentUser_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client ->
                LibraryApis(client).saveItemsForCurrentUser(listOf("spotify:track:t1"))
            }
    ...
    @Test
    fun removeUsersSavedItems_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created<Boolean> { client ->
    ...
    @Test
    fun removeUsersSavedItems_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client ->
                LibraryApis(client).removeUsersSavedItems(listOf("spotify:track:t1"))
            }
    ...
    @Test
    fun removeUsersSavedItems_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client ->
                LibraryApis(client).removeUsersSavedItems(listOf("spotify:track:t1"))
            }
    ...
    @Test
    fun removeUsersSavedItems_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client ->
                LibraryApis(client).removeUsersSavedItems(listOf("spotify:track:t1"))
            }
    ...
    @Test
    fun checkUsersSavedItems_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created(
    ...
    @Test
    fun checkUsersSavedItems_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client ->
    ...
    @Test
    fun checkUsersSavedItems_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client ->
                LibraryApis(client).checkUsersSavedItems(listOf("spotify:track:t1"))
            }
    ...
    @Test
    fun checkUsersSavedItems_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client ->
                LibraryApis(client).checkUsersSavedItems(listOf("spotify:track:t1"))
            }
