...
class ArtistsApisTest {
    ...
    @Test
    fun getArtist_nonSuccess_throws_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created { client -> ArtistsApis(client).getArtist("id") }
        }

    @Test
    fun getArtist_nonSuccess_throws_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client -> ArtistsApis(client).getArtist("id") }
        }

    @Test
    fun getArtist_nonSuccess_throws_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client -> ArtistsApis(client).getArtist("id") }
        }

    @Test
    fun getArtist_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client -> ArtistsApis(client).getArtist("id") }
        }

    @Test
    fun getSeveralArtists_nonSuccess_throws_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created { client -> ArtistsApis(client).getSeveralArtists(listOf("a", "b")) }
        }

    @Test
    fun getSeveralArtists_nonSuccess_throws_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client -> ArtistsApis(client).getSeveralArtists(listOf("a", "b")) }
        }

    @Test
    fun getSeveralArtists_nonSuccess_throws_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client -> ArtistsApis(client).getSeveralArtists(listOf("a", "b")) }
        }

    @Test
    fun getSeveralArtists_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client -> ArtistsApis(client).getSeveralArtists(listOf("a", "b")) }
        }

    @Test
    fun getArtistsAlbums_nonSuccess_throws_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created { client ->
                ArtistsApis(client).getArtistsAlbums("id", includeGroups = listOf(IncludeGroup.Album))
            }
        }

    @Test
    fun getArtistsAlbums_nonSuccess_throws_status401_unauthorized() =
        runTest {
    ...
    @Test
    fun getArtistsAlbums_nonSuccess_throws_status403_forbidden() =
        runTest {
    ...
    @Test
    fun getArtistsAlbums_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
