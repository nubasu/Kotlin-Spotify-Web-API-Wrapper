...
class AudiobooksApisTest {
    ...
    @Test
    fun saveAudiobooksForCurrentUser_nonSuccess_throws_status403_forbidden() =
        runTest {
    ...
    @Test
    fun saveAudiobooksForCurrentUser_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client ->
                AudiobooksApis(client).saveAudiobooksForCurrentUser(Ids(listOf("id1")))
            }
    ...
    @Test
    fun removeUsersSavedAudiobooks_nonSuccess_throws_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created { client -> AudiobooksApis(client).removeUsersSavedAudiobooks(Ids(listOf("id1"))) }
        }

    @Test
    fun removeUsersSavedAudiobooks_nonSuccess_throws_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client ->
                AudiobooksApis(client).removeUsersSavedAudiobooks(Ids(listOf("id1")))
            }
        }

    @Test
    fun removeUsersSavedAudiobooks_nonSuccess_throws_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client ->
                AudiobooksApis(client).removeUsersSavedAudiobooks(Ids(listOf("id1")))
            }
    ...
    @Test
    fun removeUsersSavedAudiobooks_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client ->
                AudiobooksApis(client).removeUsersSavedAudiobooks(Ids(listOf("id1")))
            }
    ...
    @Test
    fun checkUsersSavedAudiobooks_nonSuccess_throws_status201_created() =
        runTest {
            ApiStatusCaseAsserts.assertStatus201Created { client -> AudiobooksApis(client).checkUsersSavedAudiobooks(Ids(listOf("id1"))) }
        }

    @Test
    fun checkUsersSavedAudiobooks_nonSuccess_throws_status401_unauthorized() =
        runTest {
            ApiStatusCaseAsserts.assertStatus401Unauthorized { client ->
                AudiobooksApis(client).checkUsersSavedAudiobooks(Ids(listOf("id1")))
            }
        }

    @Test
    fun checkUsersSavedAudiobooks_nonSuccess_throws_status403_forbidden() =
        runTest {
            ApiStatusCaseAsserts.assertStatus403Forbidden { client -> AudiobooksApis(client).checkUsersSavedAudiobooks(Ids(listOf("id1"))) }
        }

    @Test
    fun checkUsersSavedAudiobooks_nonSuccess_throws_status429_tooManyRequests() =
        runTest {
            ApiStatusCaseAsserts.assertStatus429TooManyRequests { client ->
                AudiobooksApis(client).checkUsersSavedAudiobooks(Ids(listOf("id1")))
            }
